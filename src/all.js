    ...
    return (
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="flex-1 bg-white z-10 overflow-auto">
                <div className="w-full h-16 pt-4 pl-7 bg-white border sticky top-0">
                    <h1 className="text-2xl font-semibold text-gradient1">
                        FinBriefs
                    </h1>
                </div>
                <h1 className="text-4xl mt-10 mb-10 font-semibold text-gradient2 flex justify-center items-center">
                    Text{" "}
                    <span className="text-gradient3 ml-2 mr-2">Summarizer</span>{" "}
                    and <span className="text-gradient1 ml-2">Translator</span>
                </h1>
                ...
                <div className="flex flex-col h-3/4">
                    ...
                    <div className="w-full pb-3 bg-white shadow-lg flex items-end justify-center sticky bottom-0">
                        <div className="flex justify-center mt-2">
                            <div
                                className="w-full p-4 border rounded-lg relative inline-flex focus:outline-none focus:ring-2 focus:ring-[#a116a1]"
                                tabIndex="0"
                            >
                                <textarea
                                ...
                                <div className="flex items-end mt-4 ml-4">
                                    <button
                                        className={`lang-button font-medium ${
                                            language === "english"
                                                ? "bg-[#a116a1] text-white"
